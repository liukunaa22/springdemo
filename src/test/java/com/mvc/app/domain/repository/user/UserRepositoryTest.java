package com.mvc.app.domain.repository.user;
...
import com.mvc.app.domain.repository.user.UserRepository;
...
public class UserRepositoryTest {
    ...
    public void setUp() throws Exception {
        ...
        jdbcTemplate
                .batchUpdate(
                        "INSERT INTO T_USER(STU_NAME, STU_ID, SCORE, CREATED_AT, UPDATED_AT) VALUES(?,?,?,?,?)",
                        args);
    }
    ...
    public void testSaveAndFlush01() {
        ...
        assertThat((Integer) result.get("ID"), is(id));
        assertThat((String) result.get("STU_NAME"), is("foo"));
	...
	public int avg(){
    	return jdbcTemplate.queryForInt("select AVG(SCORE) from T_USER");
    }
    @SuppressWarnings("deprecation")
	public int var(){
    	return jdbcTemplate.queryForInt("select VAR(SCORE) from T_USER");
    }
}
